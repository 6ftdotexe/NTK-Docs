...
import { useActivePluginAndVersion, useAllDocsData, } from "@theme/hooks/useDocs";
import { docVersionSearchTag, DEFAULT_SEARCH_TAG, useDocsPreferredVersionByPluginId, } from "@docusaurus/theme-common";
...
const SearchBar = () => {
    ...
    const { titleBoost, contentBoost, parentCategoriesBoost, indexDocSidebarParentCategories, } = usePluginData("@cmfcmf/docusaurus-search-local");
